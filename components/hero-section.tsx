...
const HeroSection = ({ heading, subheading, image, paragraph }: any) => {
        ...
        <section className="hero-section-other w-full h-auto flex flex-col justify-center items-center">
            ...
            <div className="w-full h-auto flex items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
                <Link href={"/"} className="menu shrink-0">
                    <Image src="/images/logo-1.png" alt="logo" width={240} height={240} className="h-auto w-[90px] sm:w-[110px] lg:w-[150px] p-6" />
                </Link>
    ...
    "
        ...
        ${openMenu ? "translate-x-0" : "-translate-x-full"}`}
            ...
            {/* hero content */}
            <div className="philosophy-section bg-neutral-800 relative px-4 py-12 sm:px-6 lg:px-8 w-full h-auto min-h-screen flex flex-col justify-center items-center gap-8 lg:flex-row lg:gap-0">

                <div className="relative w-full lg:w-[40%] h-auto lg:h-screen px-0 lg:px-6 flex flex-col py-0 lg:py-14 dark:border-neutral-300/30 border-neutral-400/50 justify-between">

                    <div className="w-full h-auto lg:h-screen flex flex-col gap-6 sm:gap-8 lg:gap-12">
                        <div data-aos="fade-up" className="sub-heading flex gap-2 items-center">
                            <div className="w-1 h-1 dark:bg-white bg-white rounded-full"></div>
                            <h4 className="text-sm sm:text-base letter-spacing dark:text-white text-white uppercase">
                                {subheading ? subheading : ''}
                            </h4>

                        </div>
                        <h1 data-aos="fade-up" className="dark:text-white text-white font-medium text-3xl sm:text-4xl lg:text-4xl leading-tight lg:leading-14 max-w-4xl">
                            {heading ? heading : ''}
                        </h1>
                        <p data-aos="fade-up" className="dark:text-white text-white text-base max-w-3xl">
                            {paragraph ? paragraph : ''}
                        </p>
                        <Link href={'/contact'} className="w-fit">
                            <Button data-aos="fade-up" className="bg-white text-neutral-800 w-44 px-10 cursor-pointer text-base py-6 rounded-none mt-3 font-semibold flex gap-3 hover:text-neutral-700 hover:bg-white transition delay-150 duration-300 ease-in-out ">Contact Us<ArrowUpRight size={16} /></Button>
                        </Link>
                    </div>
                </div>
                <div className='relative w-full lg:w-[60%] h-auto lg:h-screen flex justify-center items-center'>
                    <Image data-aos="zoom-in-up" src={image} alt='Architectural process illustration' width={900} height={1800} className='h-[320px] w-full sm:h-[420px] lg:h-full object-cover' />
                </div>
            </div>
