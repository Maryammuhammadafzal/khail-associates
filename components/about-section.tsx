        ...
        <section className="about-section dark:bg-neutral-900 bg-white relative w-full h-auto min-h-screen flex flex-col justify-center items-center">
            <div className="about-bg relative w-full h-screen flex justify-center items-center">
                ...
                <div className="w-auto h-screen flex flex-col gap-12 text-center justify-center items-center">
                    ...
                    <p data-aos="fade-up" className="dark:text-white text-neutral-800 text-lg max-w-3xl">We understand every detail that goes into crafting a beautiful space. We use our experience and specialist skills to keep things running smoothly, on budget and on time.</p>
