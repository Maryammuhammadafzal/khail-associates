...
const WorkSection = () => {
    return (
        <section className="work-section bg-neutral-800  relative w-full h-auto flex overflow-x-hidden flex-col justify-center items-center ">
           {/* grid line */}
            <div className="relative w-full max-w-[1500px] mx-auto h-auto flex p-8 my-8 flex-col justify-center gap-16">
